...
class FIbmLiveStreaming final : private IMediaEncoderListener
{
public:
...
private:
	...
	// IMediaEncoderListener interface
	void OnMediaSample(const FMediaEncoderSample& Sample) override;
