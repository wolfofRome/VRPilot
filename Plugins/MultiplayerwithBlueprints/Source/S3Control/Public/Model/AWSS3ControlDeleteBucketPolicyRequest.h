...
#include "AWSS3ControlDeleteBucketPolicyRequest.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3ControlDeleteBucketPolicyRequest {
GENERATED_BODY()
...
#if WITH_S3CONTROLCLIENTSDK && WITH_CORE
public:
    Aws::S3Control::Model::DeleteBucketPolicyRequest toAWS() const {
        Aws::S3Control::Model::DeleteBucketPolicyRequest awsDeleteBucketPolicyRequest;

        if (!(this->accountId.IsEmpty())) {
            awsDeleteBucketPolicyRequest.SetAccountId(TCHAR_TO_UTF8(*this->accountId));
        }
