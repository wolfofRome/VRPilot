...
#include "AWSS3ControlDeleteBucketTaggingRequest.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3ControlDeleteBucketTaggingRequest {
GENERATED_BODY()
...
#if WITH_S3CONTROLCLIENTSDK && WITH_CORE
public:
    Aws::S3Control::Model::DeleteBucketTaggingRequest toAWS() const {
        Aws::S3Control::Model::DeleteBucketTaggingRequest awsDeleteBucketTaggingRequest;

        if (!(this->accountId.IsEmpty())) {
            awsDeleteBucketTaggingRequest.SetAccountId(TCHAR_TO_UTF8(*this->accountId));
        }
