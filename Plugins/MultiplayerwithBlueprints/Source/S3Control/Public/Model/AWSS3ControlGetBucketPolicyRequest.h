...
#include "AWSS3ControlGetBucketPolicyRequest.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3ControlGetBucketPolicyRequest {
GENERATED_BODY()
...
#if WITH_S3CONTROLCLIENTSDK && WITH_CORE
public:
    Aws::S3Control::Model::GetBucketPolicyRequest toAWS() const {
        Aws::S3Control::Model::GetBucketPolicyRequest awsGetBucketPolicyRequest;

        if (!(this->accountId.IsEmpty())) {
            awsGetBucketPolicyRequest.SetAccountId(TCHAR_TO_UTF8(*this->accountId));
        }
