...
#include "AWSS3ControlGetBucketTaggingRequest.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3ControlGetBucketTaggingRequest {
GENERATED_BODY()
...
#if WITH_S3CONTROLCLIENTSDK && WITH_CORE
public:
    Aws::S3Control::Model::GetBucketTaggingRequest toAWS() const {
        Aws::S3Control::Model::GetBucketTaggingRequest awsGetBucketTaggingRequest;

        if (!(this->accountId.IsEmpty())) {
            awsGetBucketTaggingRequest.SetAccountId(TCHAR_TO_UTF8(*this->accountId));
        }
