    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            const AwsServiceClientT* clientThis = static_cast<const AwsServiceClientT*>(this);
            return Aws::Client::MakeCallableOperation("aws", operationFunc, clientThis, request, clientThis->m_executor.get());
        }
        ...
        {
            const AwsServiceClientT* clientThis = static_cast<const AwsServiceClientT*>(this);
            return Aws::Client::MakeCallableStreamingOperation("aws", operationFunc, clientThis, request, clientThis->m_executor.get());
        }
        ...
        {
            const AwsServiceClientT* clientThis = static_cast<const AwsServiceClientT*>(this);
            return Aws::Client::MakeCallableOperation("aws", operationFunc, clientThis, clientThis->m_executor.get());
        }
    };
} // namespace Client
} // namespace Aws
