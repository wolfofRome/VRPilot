...
#include "DynamoDBStreamsError.generated.h"

UENUM(BlueprintType)
enum class EDynamoDBStreamsError : uint8 {
    //From Core//
    //////////////////////////////////////////////////////////////////////////////////////////
    ...
    EXPIRED_ITERATOR UMETA(DisplayName = "Expired Iterator"),
    LIMIT_EXCEEDED UMETA(DisplayName = "Limit Exceeded"),
    TRIMMED_DATA_ACCESS UMETA(DisplayName = "Trimmed Data Access")
};
