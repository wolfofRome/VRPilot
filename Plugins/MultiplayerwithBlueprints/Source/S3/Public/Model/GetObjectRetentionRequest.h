...
#include "GetObjectRetentionRequest.generated.h"
...
#if WITH_S3CLIENTSDK && WITH_CORE
public:
    Aws::S3::Model::GetObjectRetentionRequest toAWS() const {
        Aws::S3::Model::GetObjectRetentionRequest awsGetObjectRetentionRequest;
        ...
        switch(this->requestPayer) {
            case EAWSRequestPayer::requester:
                awsGetObjectRetentionRequest.SetRequestPayer(Aws::S3::Model::RequestPayer::requester);
                break;
            default:
                break;
		}
