...
#include "DeleteBucketTaggingRequest.generated.h"
...
#if WITH_S3CLIENTSDK && WITH_CORE
public:
    Aws::S3::Model::DeleteBucketTaggingRequest toAWS() const {
        Aws::S3::Model::DeleteBucketTaggingRequest awsDeleteBucketTaggingRequest;
