...
public:
    FUpdateEventSourceMappingResult &fromAWS(const Aws::Lambda::Model::UpdateEventSourceMappingResult &awsUpdateEventSourceMappingResult) {
        ...
        this->filterCriteria.fromAWS(awsUpdateEventSourceMappingResult.GetFilterCriteria());
        ...
        this->selfManagedEventSource.fromAWS(awsUpdateEventSourceMappingResult.GetSelfManagedEventSource());
        ...
        this->amazonManagedKafkaEventSourceConfig.fromAWS(awsUpdateEventSourceMappingResult.GetAmazonManagedKafkaEventSourceConfig());

        this->selfManagedKafkaEventSourceConfig.fromAWS(awsUpdateEventSourceMappingResult.GetSelfManagedKafkaEventSourceConfig());
