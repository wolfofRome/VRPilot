...
#include "AWSDynamoDBEnableKinesisStreamingDestinationResult.generated.h"
...
#if WITH_DYNAMODBCLIENTSDK && WITH_CORE
public:
    FAWSDynamoDBEnableKinesisStreamingDestinationResult &fromAWS(const Aws::DynamoDB::Model::EnableKinesisStreamingDestinationResult &awsEnableKinesisStreamingDestinationResult) {
        this->tableName = UTF8_TO_TCHAR(awsEnableKinesisStreamingDestinationResult.GetTableName().c_str());

        this->streamArn = UTF8_TO_TCHAR(awsEnableKinesisStreamingDestinationResult.GetStreamArn().c_str());

        switch(awsEnableKinesisStreamingDestinationResult.GetDestinationStatus()) {
