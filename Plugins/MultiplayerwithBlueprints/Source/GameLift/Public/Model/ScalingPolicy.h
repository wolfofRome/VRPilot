    ...
    FScalingPolicy &fromAWS(const Aws::GameLift::Model::ScalingPolicy &awsScalingPolicy) {
        ...
        switch(awsScalingPolicy.GetMetricName()) {
            ...
            case Aws::GameLift::Model::MetricName::WaitTime:
                ...
                break;
            case Aws::GameLift::Model::MetricName::ConcurrentActivatableGameSessions:
                this->metricName = EMetricName::ConcurrentActivatableGameSessions;
                break;
            default:
                this->metricName = EMetricName::NOT_SET;
                break;
        ...
        this->targetConfiguration.fromAWS(awsScalingPolicy.GetTargetConfiguration());
