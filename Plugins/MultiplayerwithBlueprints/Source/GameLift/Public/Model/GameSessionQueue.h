...
public:
    FGameSessionQueue &fromAWS(const Aws::GameLift::Model::GameSessionQueue &awsGameSessionQueue) {
        ...
        this->filterConfiguration.fromAWS(awsGameSessionQueue.GetFilterConfiguration());

        this->priorityConfiguration.fromAWS(awsGameSessionQueue.GetPriorityConfiguration());
