    ...
    FFleetAttributes &fromAWS(const Aws::GameLift::Model::FleetAttributes &awsFleetAttributes) {
        ...
        switch(awsFleetAttributes.GetStatus()) {
            ...
            case Aws::GameLift::Model::FleetStatus::TERMINATED:
                ...
                break;
            case Aws::GameLift::Model::FleetStatus::NOT_FOUND:
                this->status = EFleetStatus::NOT_FOUND;
                break;
            default:
                this->status = EFleetStatus::NOT_SET;
                break;
        ...
        switch(awsFleetAttributes.GetComputeType()) {
            case Aws::GameLift::Model::ComputeType::NOT_SET:
                this->computeType = EAWSGameLiftComputeType::NOT_SET;
                break;
            case Aws::GameLift::Model::ComputeType::EC2:
                this->computeType = EAWSGameLiftComputeType::EC2;
                break;
            case Aws::GameLift::Model::ComputeType::ANYWHERE:
                this->computeType = EAWSGameLiftComputeType::ANYWHERE;
                break;
            default:
                this->computeType = EAWSGameLiftComputeType::NOT_SET;
                break;
        ...
        this->anywhereConfiguration.fromAWS(awsFleetAttributes.GetAnywhereConfiguration());
