    ...
    Aws::GameLift::Model::PutScalingPolicyRequest toAWS() const {
        ...
        switch(this->metricName) {
            ...
            case EMetricName::WaitTime:
                ...
                break;
            case EMetricName::ConcurrentActivatableGameSessions:
                awsPutScalingPolicyRequest.SetMetricName(Aws::GameLift::Model::MetricName::ConcurrentActivatableGameSessions);
                break;
            default:
                break;
        }
