...
public:
    FDescribeIdentityPoolResult &fromAWS(const Aws::CognitoIdentity::Model::DescribeIdentityPoolResult &awsDescribeIdentityPoolResult) {
        ...
        this->allowClassicFlow = awsDescribeIdentityPoolResult.GetAllowClassicFlow();

        this->supportedLoginProviders.Empty();
        for (const auto& elem : awsDescribeIdentityPoolResult.GetSupportedLoginProviders()) {
        ...
        for (const auto& elem : awsDescribeIdentityPoolResult.GetIdentityPoolTags()) {
