...
#include "AWSS3CRTGetBucketNotificationConfigurationRequest.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3CRTGetBucketNotificationConfigurationRequest {
GENERATED_BODY()
...
#if WITH_S3CRTCLIENTSDK && WITH_CORE
public:
    Aws::S3Crt::Model::GetBucketNotificationConfigurationRequest toAWS() const {
        Aws::S3Crt::Model::GetBucketNotificationConfigurationRequest awsGetBucketNotificationConfigurationRequest;
