...
#include "AWSS3CRTListObjectsV2Request.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3CRTListObjectsV2Request {
GENERATED_BODY()

    /**
    *  <p>Bucket name to list. </p> <p>When using this action with an access point, you must direct requests to the access point hostname. The access point hostname takes the form <i>AccessPointName</i>-<i>AccountId</i>.s3-accesspoint.<i>Region</i>.amazonaws.com. When using this action with an access point through the AWS SDKs, you provide the access point ARN in place of the bucket name. For more information about access point ARNs, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-access-points.html">Using Access Points</a> in the <i>Amazon S3 User Guide</i>.</p> <p>When using this action with Amazon S3 on Outposts, you must direct requests to the S3 on Outposts hostname. The S3 on Outposts hostname takes the form <i>AccessPointName</i>-<i>AccountId</i>.<i>outpostID</i>.s3-outposts.<i>Region</i>.amazonaws.com. When using this action using S3 on Outposts through the AWS SDKs, you provide the Outposts bucket ARN in place of the bucket name. For more information about S3 on Outposts ARNs, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/S3onOutposts.html">Using S3 on Outposts</a> in the <i>Amazon S3 User Guide</i>.</p>
    **/
...
#if WITH_S3CRTCLIENTSDK && WITH_CORE
public:
    Aws::S3Crt::Model::ListObjectsV2Request toAWS() const {
        Aws::S3Crt::Model::ListObjectsV2Request awsListObjectsV2Request;
        ...
        switch(this->encodingType) {
            case EAWSS3CRTEncodingType::url:
                awsListObjectsV2Request.SetEncodingType(Aws::S3Crt::Model::EncodingType::url);
                break;
            default:
                break;
        }
        ...
        switch(this->requestPayer) {
            case EAWSS3CRTRequestPayer::requester:
                awsListObjectsV2Request.SetRequestPayer(Aws::S3Crt::Model::RequestPayer::requester);
                break;
            default:
                break;
        }
    ...
    bool IsEmpty() const {
        return this->bucket.IsEmpty() && this->delimiter.IsEmpty() && this->encodingType == EAWSS3CRTEncodingType::NOT_SET && this->maxKeys == 0 && this->prefix.IsEmpty() && this->continuationToken.IsEmpty() && false && this->startAfter.IsEmpty() && this->requestPayer == EAWSS3CRTRequestPayer::NOT_SET && this->expectedBucketOwner.IsEmpty() && this->customizedAccessLogTag.Num() == 0;
    }
#endif
};
