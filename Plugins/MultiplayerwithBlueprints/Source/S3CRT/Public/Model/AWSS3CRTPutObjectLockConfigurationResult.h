...
#include "AWSS3CRTPutObjectLockConfigurationResult.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3CRTPutObjectLockConfigurationResult {
GENERATED_BODY()
...
#if WITH_S3CRTCLIENTSDK && WITH_CORE
public:
    FAWSS3CRTPutObjectLockConfigurationResult &fromAWS(const Aws::S3Crt::Model::PutObjectLockConfigurationResult &awsPutObjectLockConfigurationResult) {
        switch(awsPutObjectLockConfigurationResult.GetRequestCharged()) {
