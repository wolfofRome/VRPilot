...
#include "AWSS3CRTDeleteBucketReplicationRequest.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3CRTDeleteBucketReplicationRequest {
GENERATED_BODY()
...
#if WITH_S3CRTCLIENTSDK && WITH_CORE
public:
    Aws::S3Crt::Model::DeleteBucketReplicationRequest toAWS() const {
        Aws::S3Crt::Model::DeleteBucketReplicationRequest awsDeleteBucketReplicationRequest;
