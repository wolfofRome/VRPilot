...
#include "AWSS3CRTCORSRule.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3CRTCORSRule {
GENERATED_BODY()
...
#if WITH_S3CRTCLIENTSDK && WITH_CORE
public:
    Aws::S3Crt::Model::CORSRule toAWS() const {
        Aws::S3Crt::Model::CORSRule awsCORSRule;
    ...
    FAWSS3CRTCORSRule &fromAWS(const Aws::S3Crt::Model::CORSRule &awsCORSRule) {
