...
#include "AWSS3CRTPutObjectAclResult.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3CRTPutObjectAclResult {
GENERATED_BODY()
...
#if WITH_S3CRTCLIENTSDK && WITH_CORE
public:
    FAWSS3CRTPutObjectAclResult &fromAWS(const Aws::S3Crt::Model::PutObjectAclResult &awsPutObjectAclResult) {
