...
#include "AWSS3CRTHeadBucketRequest.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3CRTHeadBucketRequest {
GENERATED_BODY()
...
#if WITH_S3CRTCLIENTSDK && WITH_CORE
public:
    Aws::S3Crt::Model::HeadBucketRequest toAWS() const {
        Aws::S3Crt::Model::HeadBucketRequest awsHeadBucketRequest;
