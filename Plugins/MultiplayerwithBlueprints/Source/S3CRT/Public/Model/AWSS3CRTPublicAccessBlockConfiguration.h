...
#include "AWSS3CRTPublicAccessBlockConfiguration.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3CRTPublicAccessBlockConfiguration {
GENERATED_BODY()
...
#if WITH_S3CRTCLIENTSDK && WITH_CORE
public:
    Aws::S3Crt::Model::PublicAccessBlockConfiguration toAWS() const {
        Aws::S3Crt::Model::PublicAccessBlockConfiguration awsPublicAccessBlockConfiguration;
    ...
    FAWSS3CRTPublicAccessBlockConfiguration &fromAWS(const Aws::S3Crt::Model::PublicAccessBlockConfiguration &awsPublicAccessBlockConfiguration) {
