...
#include "AWSS3CRTPutObjectLegalHoldResult.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3CRTPutObjectLegalHoldResult {
GENERATED_BODY()
...
#if WITH_S3CRTCLIENTSDK && WITH_CORE
public:
    FAWSS3CRTPutObjectLegalHoldResult &fromAWS(const Aws::S3Crt::Model::PutObjectLegalHoldResult &awsPutObjectLegalHoldResult) {
        switch(awsPutObjectLegalHoldResult.GetRequestCharged()) {
