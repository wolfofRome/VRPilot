...
#include "AWSS3CRTGetBucketAccelerateConfigurationRequest.generated.h"

USTRUCT(BlueprintType)
struct FAWSS3CRTGetBucketAccelerateConfigurationRequest {
GENERATED_BODY()
...
#if WITH_S3CRTCLIENTSDK && WITH_CORE
public:
    Aws::S3Crt::Model::GetBucketAccelerateConfigurationRequest toAWS() const {
        Aws::S3Crt::Model::GetBucketAccelerateConfigurationRequest awsGetBucketAccelerateConfigurationRequest;
